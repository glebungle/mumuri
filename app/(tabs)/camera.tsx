                    ...
                    <View style={styles.cameraWrap}>
                        ...
                        <View style={styles.floatingTopButtons}>
                            ...
                            <Pressable style={styles.floatBtn} onPress={() => Alert.alert('준비중', '앨범은 다음 단계에서 연결할게요!')}>
                                <Feather name="image" size={20} color="#6198FF" />
                            </Pressable>
                        ...
                        <View style={styles.hintBubbleWrap}>
                            <View style={styles.hintBubble}>
                                <AppText style={styles.hintText}>상대방이 주말을 어떻게 보내고 있을지 찍어 보내주세요</AppText>
                            </View>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    hintText: { color: '#6198FF', fontSize:12, textAlign: 'center'},
    ...
    shutterInner: {
        width: 56, height: 56, borderRadius: 32, // 원형
        backgroundColor: '#6198FF', // 파란색
        borderWidth: 4,
        borderColor: '#fff',
    },
