...
const styles = StyleSheet.create({
  ...
  topHeaderContainer: { position: 'absolute', top: '10%', left: 0, right: 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, zIndex: 10 },
  ...
  hintBubbleWrap: { position: 'absolute', top: screenHeight * 0.15, width: '100%', alignItems: 'center', paddingHorizontal: 24 },
  ...
  bottomButtonsRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', paddingHorizontal: 40, marginBottom:'25%', },
