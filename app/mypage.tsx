...
const MemoizedProfileImage = React.memo(
  ({ source }: { source: any }) => {
    return (
      <View style={styles.avatarPlaceholder}>
        <Image source={source} style={styles.profileImage} resizeMode="cover" />
      </View>
    );
  },
  (prev, next) => {
...
export default function MyPage() {
  ...
  const handlePressSetting = () => router.push("/setting");
  const handlePressEditProfile = () => router.push("/edit");
  ...
  const dDayCount = userData?.date ?? 1;
        ...
        >
          ...
          <View style={styles.profileSection}>
            <View style={styles.avatarContainer}>
              <MemoizedProfileImage source={displayProfileImage} />
            </View>
...
const styles = StyleSheet.create({
  ...
  bigNumberText: { fontSize: 22, color: "#444", marginBottom: 4 },
